  ...
  render() {
    return (
      <div className="filters">
        <div className="row">
          <div className="col-sm-4 col-md-4 col-lg-4" id="filter-block"><img src="generic_profile.png" />New</div>
          <div className="col-sm-4 col-md-4 col-lg-4" id="filter-block"><img src="generic_profile.png" />Popular</div>
          <div className="col-sm-4 col-md-4 col-lg-4" id="filter-block"><img src="generic_profile.png" />Friends</div>
        </div>
        <div className="row">
